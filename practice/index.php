        ...
        <div class="main__desc-group">
            ...
            <div class="main__desc-group-area wow animated fadeInLeft">
                <div class="main__desc-group-area-img">
                    <img src="image/feature-item01.png" alt="説明画像１">
                </div>
            ...
            <div class="main__desc-group-area wow animated fadeInRight">
                <div class="main__desc-group-area-img">
                    <img src="image/feature-item02.png" alt="説明画像２">
                </div>
                <div class="main__desc-group-area-content">
            ...
            <div class="main__desc-group-area wow animated fadeInLeft">
                <div class="main__desc-group-area-img">
                    <img src="image/feature-item03.png" alt="説明画像３">
                </div>
                <div class="main__desc-group-area-content">
    ...
    <section class="main__plan">
        ...
        <div class="main__plan-list" id="slider">
            ...
            <div class="main__plan-list-block">
                <a href="">
                    <div class="main__plan-list-block-img">
                        <img src="image/rec-plan01.png" alt="おすすめプラン画像１">
                    </div>
            ...
            <div class="main__plan-list-block">
                <a href="">
                    <div class="main__plan-list-block-img">
                        <img src="image/rec-plan02.png" alt="おすすめプラン画像2">
                    </div>
                    <div class="main__plan-list-block-content">
                        <p class="main__plan-list-block-content-title">
            ...
            <div class="main__plan-list-block">
                <a href="">
                    <div class="main__plan-list-block-img">
                        <img src="image/rec-plan03.png" alt="おすすめプラン画像3">
                    </div>
                    <div class="main__plan-list-block-content">
                        <p class="main__plan-list-block-content-title">
            ...
            <div class="main__plan-list-block">
                <a href="">
                    <div class="main__plan-list-block-img">
                        <img src="image/rec-plan04.png" alt="おすすめプラン画像4">
                    </div>
                    <div class="main__plan-list-block-content">
                        <p class="main__plan-list-block-content-title">
            ...
            <div class="main__plan-list-block">
                <a href="">
                    <div class="main__plan-list-block-img">
                        <img src="image/rec-plan05.png" alt="おすすめプラン画像5">
                    </div>
                    <div class="main__plan-list-block-content">
                        <p class="main__plan-list-block-content-title">
        ...
        <div class="main__plan-point">
            <div class="main__plan-point-card">
                <div class="main__plan-point-card-img">
                    <img src="image/service-item01.png" alt="サービスアイテム画像1">
                </div>
                <h3>最低価格保証</h3>
            ...
            <div class="main__plan-point-card">
                <div class="main__plan-point-card-img">
                    <img src="image/service-item02.png" alt="サービスアイテム画像2">
                </div>
                <h3>全客室Wi-Fi無料</h3>
            ...
            <div class="main__plan-point-card">
                <div class="main__plan-point-card-img">
                    <img src="image/service-item03.png" alt="サービスアイテム画像3">
                </div>
                <h3>会員限定料金</h3>
    ...
    <section class="main__blog">
        ...
        <div class="main__blog-list">
            <ul>
                <li>
                    <p>お知らせ</p>
                    <a href="blog.html">年4月より、極楽亭に新たに宴会場「風の間」が新設されました。</a>
                </li>
                <li>
                    <p>お知らせ</p>
                    <a href="blog.html">2021年5月より、極楽亭の別館が開館します！こちらも予約を随時、受付けております。</a>
                </li>
                <li>
                    <p>採用</p>
                    <a href="blog.html">2021年度の採用募集を開始いたしました。一緒に極楽亭を盛り上げていきませんか？</a>
                </li>
                <li>
                    <p>お知らせ</p>
                    <a href="blog.html">2021年2月20日、極楽亭の創業50年を迎えました。</a>
                </li>
                <li>
                    <p>イベント</p>
                    <a href="blog.html">2020年12月25日までクリスマスフェア開催中です！出来立てのお料理を絶景とともに お愉しみいただけます。</a>
                </li>
            </ul>
            <button>もっと見る</button>
        </div>
